...
<div dir="rtl">
<ul>
<li><a href="#about-get">درباره‌ی Get</a></li>
<li><a href="#installing">نصب</a></li>
<li><a href="#installing">برنامه‌ی 'Counter' با GetX</a></li>
<li><a href="#the-three-pillars">ارکان سه‌گانه</a><ul>
<li><a href="#state-management">مدیریت حالت (State management)</a><ul>
<li><a href="#reactive-state-manager">مدیریت حالت واکنشی (Reactive State Management)</a></li>
<li><a href="#more-details-about-state-management">جزئیات بیشتر درباره‌ی مدیریت حالت</a></li>
</ul>
</li>
<li><a href="#route-management">مدیریت مسیر (Route Management)</a><ul>
<li><a href="#more-details-about-route-management">جزئیات بیشتر درباره‌ی مدیریت مسیر</a></li>
</ul>
</li>
<li><a href="#dependency-management">مدیریت وابستگی‌ها (Dependency Management)</a><ul>
<li><a href="#more-details-about-dependency-management">جزئیات بیشتر درباره‌ی مدیریت وابستگی‌ها</a></li>
</ul>
</li>
</ul>
</li>
<li><a href="#utils">کاربردها</a><ul>
<li><a href="#internationalization">بین‌المللی سازی</a><ul>
<li><a href="#translations">ترجمه‌ها</a><ul>
<li><a href="#using-translations">استفاده از ترجمه‌ها</a></li>
</ul>
</li>
<li><a href="#locales">منطقه‌ها</a><ul>
<li><a href="#change-locale">عوض‌ کردن منطقه</a></li>
<li><a href="#system-locale">‌منطقه‌ی سیستم</a></li>
</ul>
</li>
</ul>
</li>
<li><a href="#change-theme">عوض کردن theme</a></li>
<li><a href="#getconnect">GetConnect</a><ul>
<li><a href="#default-configuration">پیکربندی پیش‌فرض</a></li>
<li><a href="#custom-configuration">پیکربندی سفارشی</a></li>
</ul>
</li>
<li><a href="#getpage-middleware">GetPage Middleware</a><ul>
<li><a href="#priority">اولویت</a></li>
<li><a href="#redirect">تغییر مسیر</a></li>
<li><a href="#onpagecalled">onPageCalled</a></li>
<li><a href="#onbindingsstart">OnBindingsStart</a></li>
<li><a href="#onpagebuildstart">OnPageBuildStart</a></li>
<li><a href="#onpagebuilt">OnPageBuilt</a></li>
<li><a href="#onpagedispose">OnPageDispose</a></li>
</ul>
</li>
<li><a href="#other-advanced-apis">سایر API های پیشرفته</a><ul>
<li><a href="#optional-global-settings-and-manual-configurations">تنظیمات global دلخواه و پیکربندی‌های دستی</a></li>
<li><a href="#local-state-widgets">State Widget های local</a><ul>
<li><a href="#valuebuilder">ValueBuilder</a></li>
<li><a href="#obxvalue">ObxValue</a></li>
</ul>
</li>
</ul>
</li>
<li><a href="#useful-tips">نکات مفید</a><ul>
<li><a href="#getview">GetView</a></li>
<li><a href="#getresponsiveview">GetResponsiveView</a><ul>
<li><a href="#how-to-use-it">نحوه‌ی استفاده</a></li>
</ul>
</li>
<li><a href="#getwidget">GetWidget</a></li>
<li><a href="#getxservice">GetxService</a></li>
</ul>
</li>
</ul>
</li>
<li><a href="#breaking-changes-from-20">تغییرات اساسی از نسخه‌ی 2.0 به بعد</a></li>
<li><a href="#why-getx">چرا GetX؟</a></li>
<li><a href="#community">انجمن</a><ul>
<li><a href="#community-channels">کانال‌های انجمن</a></li>
<li><a href="#how-to-contribute">نحوه‌ی مشارکت</a></li>
<li><a href="#articles-and-videos">مقالات و ویدیو‌ها</a></li>
</ul>
</li>
</ul>
</div>
